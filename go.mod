...
require (
	...
	github.com/overmindtech/connect v0.8.4
	github.com/overmindtech/discovery v0.18.1
	github.com/overmindtech/sdp-go v0.18.1
...
require (
	...
	github.com/overmindtech/sdpcache v1.2.2 // indirect
